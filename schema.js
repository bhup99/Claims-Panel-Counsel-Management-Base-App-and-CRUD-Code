...
var panelCounselTable = "CREATE TABLE DataList (State_Represented VARCHAR(2),Department VARCHAR(3),Status VARCHAR(30), Administrative_Defence VARCHAR(30),Coverage VARCHAR(10),Construction_Defect VARCHAR(30),Cyber VARCHAR(10),Property VARCHAR(10),Casualty VARCHAR(10),Surety VARCHAR(10),Fidelty VARCHAR(10),Subrogation VARCHAR(30),Sex_Abuse VARCHAR(30),Strategic VARCHAR(10),Firm_Name VARCHAR(30),Name VARCHAR(30),Key_Contact VARCHAR(15),Phone VARCHAR(15),Email VARCHAR(255),Address VARCHAR(255),City VARCHAR(255),State VARCHAR(2),Zip INT,ZipExtra SMALLINT,Vendor_Number INT,Rate VARCHAR(255),Partner INT,Associate INT,Paralegal INT,Notes VARCHAR(255),id int PRIMARY KEY AUTO_INCREMENT, Vendor_Type VARCHAR(30) DEFAULT \"Attorney\", Rate_Changed_By INT, FOREIGN KEY(Rate_Changed_By) REFERENCES DataList(id), Rate_Approval_Date VARCHAR(30), Date_Status_Changed VARCHAR(30), Status_Changed_By VARCHAR(30));"
